...
const darkGreen  = Color(0xFF332D56);
const lightGreen = Color(0xFF4E6688);
const graytext=Color(0xFF707070);
const IconLightBlue = Color(0xFF00BCD4);
const darkBlue = Color(0xFF1E2C45);
const mainBlue = Color(0xFF121A2E);
